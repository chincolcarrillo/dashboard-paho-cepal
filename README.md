...
Los archivos de `data/dashboard/` son los insumos de las páginas. No es necesario cargar los CSV BACI durante el render.

## Organización del dashboard

Existe una página por cada categoría de `hc_cat2`. Todas incluyen la misma estructura base de análisis y se construyen desde `dashboard/_category-body.qmd`. Los archivos de categoría solo fijan parámetros y contenido específico.
...
3. Reconstruya personalmente las bases corriendo `r/01_clean_baci.R`.
